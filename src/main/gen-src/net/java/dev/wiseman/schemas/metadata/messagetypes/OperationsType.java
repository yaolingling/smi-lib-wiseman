 ...
 *       &lt;sequence>
 *         &lt;element name="operation" type="{http://schemas.wiseman.dev.java.net/metadata/messagetypes}OperationNodeType" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class OperationsType {
    ...
    protected List<OperationNodeType> operation;
     ...
     * 
     * <p>
     * Objects of the following type(s) are allowed in the list {@link OperationNodeType }
     * 
     * 
     */
    public List<OperationNodeType> getOperation() {
        if (operation == null) {
            operation = new ArrayList<OperationNodeType>();
        }
