 ...
 *
 * $Id: UnsupportedExpirationTypeFault.java,v 1.3 2006-05-01 23:32:22 akhilarora Exp $
 */
...
public class UnsupportedExpirationTypeFault extends SenderFault {
    ...
    public static final QName UNSUPPORTED_EXPIRATION_TYPE = 
            new QName(Eventing.NS_URI, "UnsupportedExpirationType", Eventing.NS_PREFIX);
    ...
    public UnsupportedExpirationTypeFault(final Node... details) {
        super(Eventing.FAULT_ACTION_URI, UNSUPPORTED_EXPIRATION_TYPE, 
