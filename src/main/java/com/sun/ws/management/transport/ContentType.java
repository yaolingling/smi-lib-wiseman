...
public final class ContentType {
    ...
    private static final String SOAP_ATTACH_TYPE = "Multipart/Related";
    ...
    public static ContentType createFromHttpContentType(final String httpContentType) {
        ...
        for(final String type : httpContentType.split(";")) {
            ...
            if (SOAP_MIME_TYPE.equals(trimType) || SOAP_ATTACH_TYPE.equalsIgnoreCase(trimType)) {
                foundMimeType = true;
    ...
    public static ContentType createFromAttachment() {
        final ContentType contentType = new ContentType();
        contentType.mimeType =SOAP_ATTACH_TYPE;
        contentType.encoding = DEFAULT_CHARSET;
        contentType.acceptable = true;
        return contentType;
    }
